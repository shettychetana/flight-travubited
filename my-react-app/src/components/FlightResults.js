...
const FlightResults = ({ segment, index }) => {
    ...
    <Row className="g-4">
       ...
       onClick={() => navigate('/booking', { state: { flight: flight } })}
        variant=""
      >
        Book Now
      </Button>
      ...
      <Card.Body>
        ...
        <p className="text-muted mt-3">*From the Time of Departure</p>
            ...
            <Tab eventKey="additional" title="Additional Info">
              ...
              <p>
                <strong>Equipment Type:</strong> {segment.fD.eT}
              </p>
              <p>
                <strong>Is Return Segment:</strong> {segment.isRs ? "Yes" : "No"}
              </p>
              <p>
                <strong>Is Flight Overnight:</strong> {segment.Iand ? "Yes" : "No"}
              </p>
            </Tab>
          </Tabs>
        </div>
